...
| Portal lifecycle | 50.000 chu kỳ pass |
| AddressSanitizer | 6/6 pass |
| JavaScript syntax | 2/2 block pass |
| Arduino-ESP32 3.3.11 | 8 target × 3 lượt pass |
| Hardware/72 giờ thực tế | Chưa chạy – không xác định chắc chắn board trên COM3/4/9 |
| UBSan | Toolchain hiện tại không hỗ trợ |